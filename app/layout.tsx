    ...
    <html lang="en">
      <body className={inter.className}>
        ...
        >
          ...
          >
            <div
              className="aspect-[1155/678] h-[75%] w-screen xl:w-[72.1875rem] bg-gradient-to-tr dark:from-indigo-400 dark:to-indigo-500 from-blue-500 to-blue-600 dark:opacity-30 opacity-40 overflow-hidden"
              style={{
                clipPath:
